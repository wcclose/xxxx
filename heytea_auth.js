/*
[rewrite_local]
^https:\/\/vip\.heytea\.com\/api\/service-member\/mall_product\/productLst\?member_type=0&page=1 url script-request-header heytea_auth.js
[mitm]
hostname = vip.heytea.com
*/

// 文件名：heytea_auth.js
const $ = new Env('HeyTeaAuthorization');
...
async function handleAuthorization(authorization) {
  // 保存Authorization
